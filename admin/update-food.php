...
if (isset($_GET['id'])) {
    ...
    // SQL Query to retrieve the selected food item
    ...
    if ($res2) {
        // Get the values based on the query result
        $row2 = mysqli_fetch_assoc($res2);
        
        // Get the individual values of the selected food
        $title = htmlspecialchars($row2['title']); // Sanitize and allow symbols
        $description = html_entity_decode($row2['description']); // Sanitize and allow symbols
        $price = $row2['price'];
